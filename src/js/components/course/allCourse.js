    ...
    /*{
        ...
        render: () => (
            ...
            <Radio.Group>
                ...
                <Radio.Button value="copyHref">复制链接</Radio.Button>
                <Radio.Button value="default"ref="myInput" onClick={this.showModal}>编辑</Radio.Button>
                <Select defaultValue="更多" className="courseTableSelect" style={{ width: 70 ,border:0}}>
...
export default class allCourse extends React.Component{
    ...
    componentWillMount(){
        fetch('http://liyang.zhishimao.ngrok.cc/api/backend/course/courseList', {
            method: "POST",
            body:'status=pageSize=10&pageIndex=1'
